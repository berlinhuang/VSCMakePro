...
// KCP BASIC
//=====================================================================
const IUINT32 IKCP_RTO_NDL = 30;		// no delay min rto(Retransmission Timeout) 无延时模式下最小超时重传时间
...
const IUINT32 IKCP_MTU_DEF = 1400;      // segment: 报文默认大小 [mtu(Maximum Transmission Unit) 网络最大传输单元]
...
const IUINT32 IKCP_THRESH_INIT = 2;     // ssthresh((slow start threshold): 慢热启动 初始窗口大小
